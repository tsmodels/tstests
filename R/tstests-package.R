...
#' @import data.table
#' @import methods
#' @importFrom stats nlminb na.omit printCoefmat ar coef dnorm integrate lm logLik residuals fitted pnorm var vcov confint qnorm sigma AIC BIC nobs simulate symnum qchisq qt arima pchisq optim pt runif
...
#' @importFrom ks kde pkde qkde dkde rkde
"_PACKAGE"
